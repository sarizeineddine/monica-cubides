  ...
  return (
    <div ref={ref} className="card-panel-bold overflow-hidden p-4 sm:p-8">
      <div className="grid grid-cols-1 gap-6 sm:gap-8 lg:grid-cols-[0.36fr_0.64fr] lg:gap-10">
        <div
          className="card-panel relative flex flex-col items-center justify-center gap-1.5 px-4 py-5 text-center sm:gap-2 sm:px-6 sm:py-9"
          style={{ backgroundColor: "var(--color-accent-tint)" }}
        >
          <div className="sm:hidden">
            <IndexBadge number={String(index + 1).padStart(2, "0")} active size={26} />
          </div>
          <div className="hidden sm:block sm:absolute sm:left-4 sm:top-4">
        ...
        <div className="flex flex-col justify-center">
          ...
          <motion.div
            ...
            animate={inView ? { opacity: 1, height: "auto", y: 0 } : {}}
